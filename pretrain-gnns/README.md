...
```
pretrain_edgepred.py --output_model_file edgepred_hgcn_unsup --gnn_type highgcn
pretrain_edgepred.py --output_model_file edgepred_gin_unsup --gnn_type gin
...
python pretrain_edgepred.py --output_model_file super_edge_gin
